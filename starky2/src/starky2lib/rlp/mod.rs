...
impl<F: RichField + Extendable<D>, const D: usize> Stark<F, D> for RlpStark<F, D> {
        ...
        P: PackedField<Scalar = FE>,
    {
        ...
        yield_constr.constraint_transition_filtered(
            next_row.output_stack[0][2] - curr_row.output_stack[4][2] - P::ONES,
            next_row.output_stack_filters[0],
        );
        yield_constr.constraint_transition_filtered(
            next_row.output_stack[0][2] - curr_row.output_stack[4][2],
            P::ONES - next_row.output_stack_filters[0],
        );
        for i in 1..5 {
            yield_constr.constraint_filtered(
                curr_row.output_stack[i][2] - curr_row.output_stack[i - 1][2] - P::ONES,
                curr_row.output_stack_filters[i],
            );
            yield_constr.constraint_filtered(
                curr_row.output_stack[i][2] - curr_row.output_stack[i - 1][2],
        ...
        yield_constr
            .constraint_filtered(curr_row.output_stack[0][0] - stack_push, opcode_is_str_push);
        ...
        yield_constr.constraint_filtered(
            curr_row.output_stack[4][0] - stack_push,
            opcode_is_str_prefix * prefix_string_in_range_case,
        );
        yield_constr.constraint_filtered(
        ...
        yield_constr.constraint_filtered(
            curr_row.output_stack[0][0] - stack_push,
            curr_row.prefix_case_tmp_3,
        );
        yield_constr.constraint_filtered(
        ...
        yield_constr.constraint_filtered(
            curr_row.output_stack[1][0] - stack_push,
            curr_row.prefix_case_tmp_3,
        );
        yield_constr.constraint_filtered(
        ...
        yield_constr.constraint_filtered(
            curr_row.output_stack[2][0] - stack_push,
            curr_row.prefix_case_tmp_3,
        );
        yield_constr.constraint_filtered(
        ...
        yield_constr.constraint_filtered(
            curr_row.output_stack[3][0] - stack_push,
            curr_row.prefix_case_tmp_3,
        );
        yield_constr.constraint_filtered(
